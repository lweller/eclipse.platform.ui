...
/**
 */
public class UpdateMapStrategy extends UpdateStrategy {
	/**
	 ...
	 *            {@link #POLICY_UPDATE}
	 */
	public UpdateMapStrategy(int updatePolicy) {
	 ...
	 *            {@link #POLICY_UPDATE}
	 */
	public UpdateMapStrategy(boolean provideDefaults, int updatePolicy) {
	 ...
	 * @param destination
	 */
	protected void fillDefaults(IObservableMap source,
			IObservableMap destination) {
	 ...
	 */
	public UpdateMapStrategy setConverter(IConverter converter) {
	 ...
	 * @return a status
	 */
	protected IStatus doPut(IObservableMap observableMap, Object key,
			Object value) {
		try {
	 ...
	 * @return a status
	 */
	protected IStatus doRemove(IObservableMap observableMap, Object key) {
		try {
